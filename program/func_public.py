...
def get_candles_historical(client, market):
    ...
    for timeframe in ISO_TIMES.keys():
        ...
        # Get data
        candles = client.public.get_candles(market=market, resolution=RESOLUTION, from_iso=from_iso, to_iso=to_iso, limit=100)
...
def construct_market_prices(client):
    ...
    # You can limit the amount to loop through to save time in development
